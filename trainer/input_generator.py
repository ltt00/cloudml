...
def parser(example_proto):
    ...
    return tokens, labels, distances, length_tensor, section_tensor, classname
...
def create_input(weights, path, batch_size, shuffle_num):
    ...
    tokens, labels, distances, length_tensors, section_tensors, classes = iterator.get_next()
    with tf.device('/gpu:0'):
    ...
    return iterator, {"input": input_tensors, "length": length_tensors, "section":section_tensors}, one_hot_classes
