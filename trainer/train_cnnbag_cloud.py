    ...
    def train(self):
        ...
        with tf.Graph().as_default():
            ...
            with tf.variable_scope('inputs'):
                train_iterator, train_features, train_labels = i_gen.create_input(embeddings, self.config['trainpath'],
                                                                                        self.config['train_batch_size'],
                                                                                        self.config['num_shuffle'])
                valid_iterator, valid_features, valid_labels = i_gen.create_input(embeddings, self.config['evalpath'],
